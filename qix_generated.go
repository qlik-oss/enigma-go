// Code generated by QIX generator (./schema/generate.go). DO NOT EDIT.
...
// • A or EXPORT_ALL
//
func (obj *GenericObject) ExportData(ctx context.Context, fileType string, path string, fileName string, exportState string) (string, []string, error) {
	result := &struct {
		Url      string   `json:"qUrl"`
		Warnings []string `json:"qWarnings"`
	}{}
...
//   |         AUDIT ACTIVITY LOG          |       SYSTEM SERVICE LOG       |
//   +-------------------------------------+--------------------------------+
//   | < MachineName>AuditActivity         | <                              |
//   | Engine.txt in Qlik                  | MachineName>ServiceEngine.txt  |
//   | Sense Enterprise <                  | in Qlik Sense Enterprise<      |
...
//
func (obj *Global) ExportApp(ctx context.Context, targetPath string, srcAppId string, ids []string) (bool, error) {
	result := &struct {
		Success bool `json:"qSuccess"`
	}{}
	err := obj.rpc(ctx, "ExportApp", result, targetPath, srcAppId, ids)
	return result.Success, err
}
