// Code generated by QIX generator (./schema/generate.go) for Qlik Associative Engine version 12.2038.0 . DO NOT EDIT.
...
const QIX_SCHEMA_VERSION = "12.2038.0"
...
//
// Stability: experimental
func (obj *Doc) ReplaceBookmark(ctx context.Context, id string, ignorePatches bool, objectIdsToPatch []string) (*RemoteObject, error) {
	result := &struct {
		Return *ObjectInterface `json:"qReturn"`
	}{}
