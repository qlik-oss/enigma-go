// Code generated by QIX generator (./schema/generate.go) for Qlik Associative Engine version 12.515.0 . DO NOT EDIT.
...
const QIX_SCHEMA_VERSION = "12.515.0"
...
type NxTrendline struct {
	...
	// • LOG or Logarithmic
	Type string `json:"qType,omitempty"`
	// Degree that was solved.
	SolvedDegree int `json:"qSolvedDegree,omitempty"`
	// This parameter is optional and is displayed in case of error.
	Error *NxValidationError `json:"qError,omitempty"`
...
type NxTrendlineDef struct {
	...
	// • LOG or Logarithmic
	Type string `json:"qType,omitempty"`
	// For a polynomial type the degree can be between 2..4
	PolynomialDegree int `json:"qPolynomialDegree,omitempty"`
