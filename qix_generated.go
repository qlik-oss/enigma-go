// Code generated by QIX generator (./schema/generate.go) for Qlik Associative Engine version 12.556.0 . DO NOT EDIT.
...
const QIX_SCHEMA_VERSION = "12.556.0"
...
func (obj *Doc) CreateBookmarkExRaw(ctx context.Context, prop interface{}, objectIdsToPatch []string) (*GenericBookmark, error) {
	...
	err := obj.rpc(ctx, "CreateBookmarkEx", result, ensureEncodable(prop), ensureEncodable(objectIdsToPatch))
	if err != nil {
		return nil, err
	}
	return &GenericBookmark{obj.session.getRemoteObject(result.Return)}, err
...
func (obj *Doc) ExportReducedDataRaw(ctx context.Context, options interface{}) (json.RawMessage, error) {
	...
	err := obj.rpc(ctx, "ExportReducedData", result, ensureEncodable(options))
	return result.DownloadInfo, err
}
