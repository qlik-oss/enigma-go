// Code generated by QIX generator (./schema/generate.go) for Qlik Associative Engine version 12.754.0 . DO NOT EDIT.
...
const QIX_SCHEMA_VERSION = "12.754.0"
...
// An application was loaded in an engine instance
...
// The temporary selection state will be stored for 30min by default.
// Stability: locked
func (obj *Doc) StoreTempSelectionState(ctx context.Context) (string, bool, error) {
	result := &struct {
		Id     string `json:"qId"`
		Return bool   `json:"qReturn"`
	}{}
	err := obj.RPC(ctx, "StoreTempSelectionState", result)
