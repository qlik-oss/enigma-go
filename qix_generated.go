// Code generated by QIX generator (./schema/generate.go) for Qlik Associative Engine version 12.700.0 . DO NOT EDIT.
...
const QIX_SCHEMA_VERSION = "12.700.0"
...
type ExtendedLayoutBookmarkData struct {
	Id                 string                `json:"qId,omitempty"`
	Active             bool                  `json:"qActive,omitempty"`
	ShowMode           int                   `json:"qShowMode,omitempty"`
...
type ExtendedPivotStateData struct {
	ExpressionPosition     int      `json:"qExpressionPosition,omitempty"`
	NumberOfLeftDimensions int      `json:"qNumberOfLeftDimensions,omitempty"`
...
type InputFieldItem struct {
	FieldName      string        `json:"qFieldName,omitempty"`
	Values         []*FieldValue `json:"qValues,omitempty"`
	PackedHashKeys []int         `json:"qPackedHashKeys,omitempty"`
}
...
// A session app could not be created
...
// Stability: locked
func (obj *Doc) GetLooselyCoupledVector(ctx context.Context) ([]int, error) {
	result := &struct {
		V []int `json:"qv"`
	}{}
...
//
// Stability: locked
func (obj *Doc) SetLooselyCoupledVector(ctx context.Context, v []int) (bool, error) {
	result := &struct {
		Return bool `json:"qReturn"`
	}{}
